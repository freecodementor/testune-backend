...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 10, 2018 at 12:39 PM
...
INSERT INTO `deployment_control` (`sno`, `for_page`, `page_id`, `class1`, `class2`, `class3`, `class4`, `class5`, `class6`, `class7`, `class8`, `class9`, `class10`, `class11`, `class12`, `gender`, `mon`, `tue`, `wed`, `thu`, `fri`, `sat`, `sun`, `start`, `end`) VALUES
...
(2, 'app', 'course_1', 'asd', 23, 2323, 'sdaa', '12', 'dfasd', '', '', '', 0, 0, '2018-08-31 10:50:00', '2018-08-31 10:50:00', '', '', 'inst_6', 0),
(3, 'app', 'asd', 'asdas', 23, 2323, 'sdaaas', '12', 'dfasd', '', '', '', 0, 0, '2018-08-31 10:50:00', '2018-08-31 10:50:00', '', '', 'inst_6', 0),
(4, 'app', 'asd', 'asd', 23, 2323, 'sdaa', '12', 'dfasd', '', '', '', 0, 0, '2018-08-31 10:50:00', '2018-08-31 10:50:00', '', '', 'inst_6', 0),
...
(18, 'CI_11', 'test_3', '', '', 'test title update 1', 'test creator update 1', 0, '2018-08-30 18:27:19', '2018-08-30 18:27:19', '', '02:45:00', 0, 0, '', 'inst_1', 'test description update 1', 1500),
...
--
ALTER TABLE `school`
  ADD CONSTRAINT `school_ibfk_1` FOREIGN KEY (`course_id`) REFERENCES `gen_course` (`course_id`);
