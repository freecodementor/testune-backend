...
$club_id =$_POST['club_category_id'];
...
if(isset($_POST['action']))
{
    ...
    if ($_POST['action']=='update'){
        $f=ren_save();        
        $club_up = "UPDATE  clubs SET club_name = '$club_name', club_description='$desc',image='$f',features='$features',launch_date='$date' where club_id= '$club_id'";
        $conn->query($club_up);
        echo "Updated";
