...
{   
    ...
    {                            //File update
                            ...
                            $work_up .= "UPDATE  workshop SET title = '$course', speaker='$speaker',description_line='$editor1',class_applicable_for='$class',subscription_level='$sub',
                            no_of_classes='$classes',school_price='$school_price',mrp_price='$price',learning='$editor2',";
    ...
    {  
        ...
        else 
        {
                             ...
                             $i=ren_save('icon');
                            //Data Upload                             
                            $sql = "INSERT INTO workshop  (title,description_line,no_of_classes,mrp_price,school_price,learning,class_applicable_for,speaker,subscription_level,";
                            ...
                            if ($_FILES['icon']['name']==''){}else{ $sql .= "course_icon,";}
                             $sql .= "prerequisites,vendor_id,club_id,start_time,end_time,date,duration) VALUES ('$course','$editor1','$classes','$price','$school_price','$editor2','$class','$speaker','$sub',";
